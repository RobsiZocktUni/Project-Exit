...
/// <summary>
/// The Main Code of the BookshelfLL_AnimationScript was written by: Wendt Hendrik
/// Parts from Hartmann Lennart are marked as regions
/// </summary>
public class BookshelfLL_AnimationScript : InteractableObject
{
    ...
    public float openAngle = -170.0f;  // Angle to rotate the door to (in degrees)
